...
namespace IMS
{
	...
	public class frmPCRORB : Form
	{
		...
		public frmPCRORB()
		{
			base.Shown += frmPCRORB_Shown;
			base.FormClosing += frmPCRORB_FormClosing;
		...
		private void InitializeComponent()
		{
			...
			base.Name = "frmPCRORB";
			base.Tag = "PCRORB";
			this.Text = "Order Balance Report";
		...
		private void frmPCRORB_Shown(object sender, EventArgs e)
		{
		...
		private void btnPRINT_Click(object sender, EventArgs e)
		{
			...
			frmRPT.ReportName = "Order Balance Report";
			frmRPT.ReportFile = PublicVar.gstrRptPath + "crptPCRORB.rpt";
			frmRPT.Params = "@COMPNM=" + MyProject.Computer.Name;
			frmRPT.Formulas = ("COMNM='" + Common.gfValidSQLStr(PublicVar.gstrCompany.Replace(",", "")) + "',RPTTITLE='Order Balance Report',DTFMT=" + Conversions.ToString(PublicVar.gintRptDateFmt) + ",QTYDS=" + PublicVar.gintQTYDS + ",AMTDS=" + PublicVar.gintAMTDS + ",PRCDS=" + PublicVar.gintPRCDS) ?? "";
		...
		private void frmPCRORB_FormClosing(object sender, FormClosingEventArgs e)
		{
