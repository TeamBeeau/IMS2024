...
namespace IMS
{
	...
	public class frmPCRPPO : Form
	{
		...
		public frmPCRPPO()
		{
			base.Shown += frmPCRPPO_Shown;
			base.FormClosing += frmPCRPPO_FormClosing;
		...
		private void frmPCRPPO_Shown(object sender, EventArgs e)
		{
		...
		private void btnPRINT_Click(object sender, EventArgs e)
		{
			...
			frmRPT.ReportName = "Plan Purchase Order Report";
			frmRPT.ReportFile = PublicVar.gstrRptPath + "crptPCRPPO.rpt";
			frmRPT.Params = "@COMPNM=" + MyProject.Computer.Name;
			frmRPT.Formulas = ("COMNM='" + Common.gfValidSQLStr(PublicVar.gstrCompany.Replace(",", "")) + "',RPTTITLE='Plan Purchase Order Report',DTFMT=" + Conversions.ToString(PublicVar.gintRptDateFmt) + ",QTYDS=" + PublicVar.gintQTYDS + ",AMTDS=" + PublicVar.gintAMTDS + ",PRCDS=" + PublicVar.gintPRCDS) ?? "";
		...
		private void frmPCRPPO_FormClosing(object sender, FormClosingEventArgs e)
		{
